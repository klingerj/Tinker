...
set CommonCompileFlags=/nologo /std:c++20 /W4 /WX /wd4127 /wd4530 /wd4201 /wd4324 /wd4100 /wd4189 /wd4996 /EHa- /GR- /Gm- /GS- /Zi /FS
...
set SourceList=../SPIR-V-VM/SpirvVM.c ../SPIR-V-VM/VMState.c ../SPIR-V-VM/VMShader.c ../SPIR-V-VM/SpirvOps.c ../SPIR-V-VM/GLSL.std.450_Ops.c ../SPIR-V-VM/Main.c
