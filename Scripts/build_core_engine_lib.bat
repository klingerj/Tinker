...
set SourceListCore=../Core/Math/VectorTypes.cpp ../Core/FileIO/FileLoading.cpp ../Core/Containers/Vector.cpp ../Core/Utilities/MemTracker.cpp ../Core/Utilities/Mem.cpp ../Core/Raytracing/AccelStructures/Octree.cpp
set OBJListCore= %OBJDir%VectorTypes.obj %OBJDir%FileLoading.obj %OBJDir%Vector.obj %OBJDir%MemTracker.obj %OBJDir%Mem.obj %OBJDir%Octree.obj 
set CompileDefines=
