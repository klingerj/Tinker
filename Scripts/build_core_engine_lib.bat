...
set SourceListCore=../Core/Math/VectorTypes.cpp ../Core/FileIO/FileLoading.cpp ../Core/Containers/Vector.cpp ../Core/Containers/HashMap.cpp ../Core/Utility/MemTracker.cpp ../Core/Mem.cpp ../Core/Raytracing/RayIntersection.cpp ../Core/Raytracing/AccelStructures/Octree.cpp ../Core/Graphics/VirtualTexture.cpp
set OBJListCore= %OBJDir%VectorTypes.obj %OBJDir%FileLoading.obj %OBJDir%Vector.obj %OBJDir%HashMap.obj %OBJDir%MemTracker.obj %OBJDir%Mem.obj %OBJDir%Octree.obj %OBJDir%RayIntersection.obj %OBJDir%VirtualTexture.obj 
set CompileDefines=
