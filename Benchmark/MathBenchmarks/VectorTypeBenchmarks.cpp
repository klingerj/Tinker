...
const uint32 numIters = 10'000'000;
...
void BM_m4MulV4_fScalar_MT()
{
  for (uint32 i = 0; i < numJobs; ++i)
  {
    ...
    jobs[i] = CreateNewThreadJob(
      ...
      {
        alignas(16)
          const m4f m = { 1.0f, 2.0f,  3.0f,  4.0f,  5.0f,  6.0f,  7.0f,  8.0f,
...
{
  alignas(16) const m4f m = { 1.0f, 2.0f,  3.0f,  4.0f,  5.0f,  6.0f,  7.0f,  8.0f,
                              9.0f, 10.0f, 11.0f, 12.0f, 13.0f, 14.0f, 15.0f, 16.0f };
