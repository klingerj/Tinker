...
{
    m2f mf = m2f(1.0f, 2.0f, 3.0f, 4.0f);
    v2f vf = v2f(5.0f, 6.0f);
    v2f resultf1 = mf * vf;
    v2f resultf2 = VectorOps::Mul_SIMD(vf, mf);
