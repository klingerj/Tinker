    ...
    namespace Network
    {
      int InitClient()
      {
        ...
        if (result != 0)
        {
          ...
          buffer[len + 1] = '\0';
          Core::Utility::LogMsg("Platform", buffer,
        ...
        {
          Core::Utility::LogMsg(
            "Platform", "Could not find a usable version of Winsock.dll. Exiting.",
            Core::Utility::LogSeverity::eCritical);
          WSACleanup();
          return 1;
        }
        ...
        {
          Core::Utility::LogMsg("Platform", "The Winsock 2.2 dll was found okay.",
        ...
        Core::Utility::LogMsg("Platform", "Attempting to connect to the server...",
                              Core::Utility::LogSeverity::eInfo);
        ...
        if (ConnectSocket == INVALID_SOCKET)
        {
          Core::Utility::LogMsg("Platform", "connect failed",
                                Core::Utility::LogSeverity::eCritical);
          WSACleanup();
          return 1;
        }
      ...
      {
        Core::Utility::LogMsg("Platform", "Shutting down client.",
                              Core::Utility::LogSeverity::eInfo);
      ...
      int SendMessageToServer()
      {
        ...
        Core::Utility::LogMsg("Platform", "Attempting to send data to the server...",
                              Core::Utility::LogSeverity::eInfo);
        char clientMsg[512] = {};
        clientMsg[0] = 'J';
        clientMsg[1] = 'o';
        ...
        if (numBytesSent > 0)
        {
          Core::Utility::LogMsg("Platform", "Successfully sent message to server",
                                Core::Utility::LogSeverity::eInfo);
        }
        else if (numBytesSent == 0)
        {
          Core::Utility::LogMsg(
            "Platform", "Received 0 bytes - connection has been gracefully closed.",
            Core::Utility::LogSeverity::eInfo);
        }
        else
        {
