...
#define ENABLE_VULKAN_DEBUG_LABELS // enables marking up vulkan objects/commands with
                                   // debug labels
...
namespace Tk
{
  namespace Graphics
  {
    ...
    typedef struct vulkan_mem_allocator
    {
      ...
      void Init(uint32 TotalAllocSize, uint32 MemoryTypeIndex,
                VkMemoryPropertyFlagBits MemPropertyFlags, VkDeviceSize AllocGranularity);
      void Destroy();
