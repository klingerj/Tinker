...
namespace BindlessSystem
{
    ...
    void Flush()
    {
        ...
        for (uint32 i = 0; i < BindlessArrayID::eMax; ++i)
        {
            ...
            Graphics::WriteDescriptorArray(BindlessDescriptorIDs[i], BindlessDescriptors[i], DESCRIPTOR_BINDLESS_ARRAY_LIMIT, (Graphics::ResourceHandle*)BindlessDescriptorData.Data());
        }
    }
