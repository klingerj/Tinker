...
namespace SwapChainCopyRenderPass
{
    ...
    {
        graphicsCommandStream->CmdLayoutTransition(gameGraphicsData.m_computeColorHandle, Tk::Graphics::ImageLayout::eRenderOptimal, Tk::Graphics::ImageLayout::eShaderRead, "Transition hdr compute to shader read");
        ...
        graphicsCommandStream->CmdDraw(DEFAULT_QUAD_NUM_INDICES, 1, 0, 0, Tk::Graphics::SHADER_ID_QUAD_BLIT_RGBA8,
