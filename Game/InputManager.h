...
private:
    ...
    keycode_callback_func* m_callbacks_keyDown[Tk::Platform::Keycode::eMax] = {};
    keycode_callback_func* m_callbacks_keyDownRepeat[Tk::Platform::Keycode::eMax] = {};
    // TODO: key up callbacks

public:
    void BindKeycodeCallback_KeyDown(uint32 keycode, keycode_callback_func callback);
    void BindKeycodeCallback_KeyDownRepeat(uint32 keycode, keycode_callback_func callback);
